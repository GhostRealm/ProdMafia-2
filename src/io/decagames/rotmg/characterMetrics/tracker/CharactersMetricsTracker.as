...
public class CharactersMetricsTracker {
      ...
      public function setBinaryData(param1:int, param2:IDataInput) : void {
         ...
         var bytes:int = param2.bytesAvailable;
          while (param2.bytesAvailable > bytes - 20)
             trace("trail", param2.readByte());
          while (param2.bytesAvailable > 0)
              trace("stats", CompressedInt.read(param2));
      ...
      public function parseCharListData(param1:XML) : void {
         var _loc2_:* = null;
         var _loc3_:* = param1.Char;
         var _loc6_:int = 0;
         var _loc5_:* = param1.Char;
